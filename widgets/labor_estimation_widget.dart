...
import 'package:agri/services/labor_estimation_service.dart';

class LaborEstimationWidget extends StatefulWidget {
  const LaborEstimationWidget({Key? key}) : super(key: key);
...
class _LaborEstimationWidgetState extends State<LaborEstimationWidget> {
  ...
  double _govtWage = 350.0;
  double _expectedWage = 450.0;
  ...
  final Map<String, String> _cropTypeMap = {
    'Tomato': 'Vegetable',
    'Potato': 'Vegetable',
    'Onion': 'Vegetable',
    'Wheat': 'Grain',
  ...
  Future<void> _calculateEstimation() async {
    ...
    try {
      final result = await _estimationService.estimateCost(
          _selectedCrop,
          _cropTypeMap[_selectedCrop] ?? 'Vegetable',
          _area,
          _selectedWageType,
          _selectedSeason,
          _govtWage,
            ...
            onChanged: (String? newValue) {
              if (newValue != null) {
                setState(() {
                  ...
                  _selectedCropType = _cropTypeMap[newValue] ?? 'Vegetable';
                });
              }
            },
          ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildResultRow(
                    ...
                    '${_estimationResult!['labor_demand']} ' +
                        languageProvider.translate('workers'),
                  ),
                  _buildResultRow(
